...
checkCF=$(curl -s --request POST http://www.crimeflare.us/cgi-bin/cfsearch.cgi -d "cfS='$cf_site'" -L --user-agent "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.31 (KHTML, like Gecko) Chrome/26.0.1410.63 Safari/537.31" > cloudflare.log)
